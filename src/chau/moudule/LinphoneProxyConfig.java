...
public interface LinphoneProxyConfig {
	 ...
	 *Because proxy configuration must be consistent, applications MUST call {@link #edit()} before doing any attempts 
	 *to modify proxy configuration (such as identity, proxy address and so on).
